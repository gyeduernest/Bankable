...
export default function Hero() {
  return (
    <div className=' lg:flex px-5 justify-between py-20  lg:px-72 lg:items-center bg-[#080809]  lg:py-32'>
      ...
      <div className='mb-8'>
          ...
          <button className='px-8 ml-10 rounded-md text-white py-3 bg-blue-700'>
            View your Trustfund
          </button>  
